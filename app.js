...
const NAMA_STORE = vars.NAMA_STORE || '@yiwei';
...
const db = new sqlite3.Database('./cvpn.db', (err) => {
  if (err) {
...
async function sendMainMenu(ctx) {
  ...
  const keyboard = [
    ...
    [
      { text: '🚀 Saluran Wa', url: 'https://whatsapp.com/channel/0029VbAJTjREFeXcWC4GV82Z' }
    ],
  ];
...
📞 Butuh bantuan? Hubungi [ADMIN](t.me/yiwei)
`;
